    ...
    public static void initialiseSwapTable()
    {
        if (checkpointSwapTable.Keys.Count == 0)
        {
           ...
           , new byte[] { 0x11, 0x75, 0x90, 0x33, 0x9C, 0x62, 0x27, 0xE3, 0x50, 0x52, 0x49, 0x43, 0x45, 0x32, 0x30, 0x36 }); // get on the ship - note, this skips straight past wake up cutscene
            ...
            //Awakened
            checkpointSwapTable.Add(new byte[] {0x99, 0x8B, 0xC5, 0x45, 0x5C, 0x69, 0xE8, 0x21, 0x57, 0x53, 0x31, 0x57, 0x50, 0x52, 0x49, 0x43 }
            , new byte[] { 0x7B, 0x49, 0x32, 0x4E, 0x61, 0x3D, 0x5B, 0x5F, 0x57, 0x53, 0x31, 0x53, 0x4D, 0x41, 0x52, 0x49 }); // start DLC
            checkpointSwapTable.Add(new byte[] { 0x7B, 0x49, 0x32, 0x4E, 0x61, 0x3D, 0x5B, 0x5F, 0x57, 0x53, 0x31, 0x53, 0x4D, 0x41, 0x52, 0x49 }
            , new byte[] { 0xCC, 0x4B, 0x29, 0x4E, 0x71, 0xBA, 0xEF, 0x09, 0x57, 0x53, 0x31, 0x53, 0x4D, 0x41, 0x52, 0x49 }); // Top of Climb
            checkpointSwapTable.Add(new byte[] { 0x72, 0xF2, 0xE2, 0x4E, 0x2E, 0xD0, 0xDF, 0xF6, 0x57, 0x53, 0x31, 0x53, 0x4D, 0x41, 0x52, 0x49 }
            , new byte[] { 0xBA, 0x9D, 0x8A, 0x4E, 0x91, 0x65, 0x2C, 0x61, 0x57, 0x53, 0x31, 0x53, 0x4D, 0x41, 0x52, 0x49 }); // Awakened end Ch1

            // Demo
            checkpointSwapTable.Add(new byte[] {0xFC, 0x64, 0x91, 0x33, 0x05, 0x55, 0xC8, 0x7F, 0x50, 0x52, 0x49, 0x43, 0x45, 0x32, 0x30, 0x36 }
            , new byte[] { 0x19, 0x35, 0x2B, 0x33, 0x2E, 0xAA, 0xEE, 0x1A, 0x50, 0x52, 0x49, 0x43, 0x45, 0x32, 0x30, 0x36 }); // start Demo
            checkpointSwapTable.Add(new byte[] { 0xBC, 0xD8, 0xC5, 0x33, 0x0F, 0xB8, 0xBF, 0xB3, 0x50, 0x52, 0x49, 0x43, 0x45, 0x32, 0x30, 0x36 }
            , new byte[] { 0xDB, 0x33, 0x4B, 0x33, 0x9F, 0xA0, 0xDB, 0x23, 0x50, 0x52, 0x49, 0x43, 0x45, 0x32, 0x30, 0x36 }); // snow plow QTE
            checkpointSwapTable.Add(new byte[] { 0xDB, 0x33, 0x4B, 0x33, 0x9F, 0xA0, 0xDB, 0x23, 0x50, 0x52, 0x49, 0x43, 0x45, 0x32, 0x30, 0x36 }
           , new byte[] { 0x16, 0x48, 0x36, 0x33, 0x53, 0x5B, 0x86, 0x39, 0x50, 0x52, 0x49, 0x43, 0x45, 0x32, 0x30, 0x36 }); // snowbeast
            checkpointSwapTable.Add(new byte[] { 0x16, 0x48, 0x36, 0x33, 0x53, 0x5B, 0x86, 0x39, 0x50, 0x52, 0x49, 0x43, 0x45, 0x32, 0x30, 0x36 }
           , new byte[] { 0x0E, 0x04, 0x9F, 0x33, 0x4C, 0x2C, 0xDC, 0x45, 0x50, 0x52, 0x49, 0x43, 0x45, 0x32, 0x30, 0x36 }); // post snowbeast
            checkpointSwapTable.Add(new byte[] { 0x44, 0x29, 0x80, 0x45, 0x64, 0x8A, 0x8E, 0xC7, 0x57, 0x53, 0x31, 0x4A, 0x48, 0x55, 0x47, 0x48 }
           , new byte[] { 0x35, 0x99, 0x05, 0x45, 0x3A, 0x62, 0x37, 0xE8, 0x57, 0x53, 0x31, 0x4A, 0x48, 0x55, 0x47, 0x48 }); // look out
        ...
        if (multiCutsceneAddresses.Keys.Count == 0)
        {
            ...
            multiCutsceneAddresses.Add(new byte[] { 0xC2, 0x6D, 0x15, 0x31, 0xDD, 0x22, 0x85, 0xB5, 0x59, 0x4D, 0x55, 0x52, 0x50, 0x48, 0x59, 0x30 }, 3); // end moon fight
            multiCutsceneAddresses.Add(new byte[] { 0x72, 0xF2, 0xE2, 0x4E, 0x2E, 0xD0, 0xDF, 0xF6, 0x57, 0x53, 0x31, 0x53, 0x4D, 0x41, 0x52, 0x49 }, 2);// Awakened end Ch1
            multiCutsceneAddresses.Add(new byte[] { 0xDB, 0x33, 0x4B, 0x33, 0x9F, 0xA0, 0xDB, 0x23, 0x50, 0x52, 0x49, 0x43, 0x45, 0x32, 0x30, 0x36 }, 2); // Demo snowbeast 1
        }
    }
